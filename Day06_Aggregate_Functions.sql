...
*/
 ...
 SELECT COUNT(urun_adi) AS 1000_TLden_ucuz_urun_sayisi
 FROM satis_raporu
...
SELECT MIN(satis_tarihi) AS minimum, MAX(satis_tarihi) AS maximum
FROM satis_raporu;

/*  =============================  SORU-12 =============================
    Satis raporu tablosundaki en fazla satilan urunun satis miktari nedir?   ===================================================================
*/

SELECT satis_miktari
FROM satis_raporu
